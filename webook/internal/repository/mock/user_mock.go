...
//
//	mockgen -source=webook/internal/repository/user.go -destination webook/internal/repository/mock/user_mock.go -package=repmock
//
// Package repmock is a generated GoMock package.
package repmock
...
import (
	...
	domain "github.com/TangTangHC/basic-go-study/webook/internal/domain"
...
func (m *MockUserRepository) UpdateById(ctx context.Context, edit domain.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateById", ctx, edit)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateById indicates an expected call of UpdateById.
func (mr *MockUserRepositoryMockRecorder) UpdateById(ctx, edit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateById", reflect.TypeOf((*MockUserRepository)(nil).UpdateById), ctx, edit)
}
